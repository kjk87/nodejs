...
// 암호화
export function encrypt(data: string, proc: string, is128: boolean = false) {
	...
	try{
		...
		throw new CoreError(E_INTERNAL_SERVER, 'encrypt fail');
	}
	
}

// 복호화
export function decrypt(data: string, proc: string, is128: boolean = false) {
											...
											<tbody>
												<tr>
													<td class="column"
														...
														<img src=" https://cdn.buflexz.com/emailImage/logo.png" alt="로고"
															style="width: 100%; display: block;">
	
													</td>
													<td></td>
													<td style="width: 50px; vertical-align: middle; height: 70px;">
														<a href="https://play.google.com/store/apps/details?id=com.root37.buflexz" style="display: block; width: 50px;">
															<img src="https://cdn.buflexz.com/emailImage/btn_g.png" alt="구글플레이 이동"
																style="width: 100%; display: block;">
														</a>
													</td>
													<td
														...
														<a href="#" style="display: block; width: 50px;">
															<img src="https://cdn.buflexz.com/emailImage/btn_a.png" alt="앱스토어 이동"
																style="width: 100%; display: block;">
														</a>
													</td>
												</tr>
															...
															<tr>
																<td
																	...
																	font-size:14px; font-weight:bold;line-height:120%;text-align:left; margin: 0;">
																		${getLang(language).authMailContents1}
																	</p>
																</td>
															</tr>
														</table>
											...
											<tbody>
												<tr>
													<td>
														...
														font-size:14px; font-weight:400;line-height:140%;text-align:left; margin: 0;">
															${getLang(language).authMailContents2}
															<br><br>
															${getLang(language).authMailContents3}
														</p>
													</td>
												</tr>
												<!-- 인증번호 -->
												...
												<tr>
													<td>
														<p style="color: #101010;   font-family: 돋움,dotum,applegothic,sans-serif;
														font-size:14px; font-weight:400;line-height:140%;text-align:left; margin: 0;">
															${getLang(language).authMailContents4}
														</p>
													</td>
												</tr>
											</tbody>
												...
												<tr>
													<td>
														<p style="font-family: 돋움,dotum,applegothic,sans-serif; font-size: 12px; font-weight: 400; margin: 0; margin-bottom: 0px; display:block; line-height: 135%; margin-top: 0; padding-left: 0;
															...
															${getLang(language).authMailContents5}
														</p>
													</td>
												</tr>
												<tr>
													...
													padding-right: 0;">
														<p
															...
															Copyright BUFLEXZ Corporation. All right reserved.
														</p>
													</td>
												</tr>
											</tbody>
															...
															<tr>
																<td
																	...
																	<p
																		style="color: #101010;   font-family: 돋움,dotum,applegothic,sans-serif;
																	font-size:14px; font-weight:bold;line-height:120%;text-align:left; margin: 0;">
																		${getLang(language).partnerMailContents1}
																	</p>
																</td>
															</tr>
														</table>
													...
													<td class="column"
														...
														<table border="0" cellpadding="0" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td style="width:100%;">
																		<img src="https://cdn.buflexz.com/emailImage/icon_01.png" alt=""
																...
																<tr>
																	<td style="padding: 0;">
																		<p style="font-family: 돋움,dotum,applegothic,sans-serif; font-size: 14px; font-weight: bold; margin-bottom: 6px; display:block; line-height: 120%; margin-top: 0; color: #101010;">
																			   ${getLang(language).partnerMailContents2}
																		</p>
																		<p style="font-family: 돋움,dotum,applegothic,sans-serif; font-weight:400; margin: 0; display: block; line-height: 120%; margin-top: 0; color: #101010; font-size: 14px;">
																			   ${getLang(language).partnerMailContents3}
																		</p>
																	</td>
																</tr>
															</tbody>
													...
													<td class="column"
														...
														<table border="0" cellpadding="0" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td style="width:100%;">
																		<img src="https://cdn.buflexz.com/emailImage/icon_02.png" alt=""
																			style="display: block; height: auto; border: 0; width: 100%; max-width: 62px;">
																	</td>
																</tr>
															</tbody>
														...
														<table border="0" cellpadding="10" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td style="padding: 0;">
																		<p style="font-family: 돋움,dotum,applegothic,sans-serif; font-size: 14px; font-weight: bold; margin-bottom: 6px; display:block; line-height: 120%; margin-top: 0; color: #101010; ;">
																		  ${getLang(language).partnerMailContents4}
																		</p>
													...
													<td class="column"
														...
														<table border="0" cellpadding="0" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td style="width:100%;">
																		<img src="https://cdn.buflexz.com/emailImage/icon_03.png" alt=""
																			style="display: block; height: auto; border: 0; width: 100%; max-width: 62px;">
																	</td>
																</tr>
															</tbody>
														...
														<table border="0" cellpadding="10" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td style="padding: 0;">
																		<p style="font-family: 돋움,dotum,applegothic,sans-serif; font-size: 14px; font-weight: bold; margin-bottom: 6px; display:block; line-height: 120%; margin-top: 0; color: #101010;">
																		  ${getLang(language).partnerMailContents7}
																		</p>
																		<p style="font-family: 돋움,dotum,applegothic,sans-serif; font-weight:400; margin: 0; display: block; line-height: 120%; margin-top: 0; color: #101010; font-size: 14px;">
																		  ${getLang(language).partnerMailContents8}
																		</p>
																	</td>
																</tr>
															</tbody>
												...
												<tr>
													<td>
														<p style="font-family: 돋움,dotum,applegothic,sans-serif; font-size: 12px; font-weight: 400; margin: 0; margin-bottom: 0px; display:block; line-height: 135%; margin-top: 0; padding-left: 0; padding-right: 0; color: #767676;">
														   ${getLang(language).partnerMailContents9}
														</p>
													</td>
												</tr>
												<tr>
