...
export const E_INVALID_ARG: IERROR	    		= {code: 400, message: 'arg error', description: '필수 파라미터 누락'};
...
export const E_UNKNOWN: IERROR			        = {code: 501, message: 'internal server error', description: '서버에러'}
...
export const E_VERYFY_FAIL: IERROR              = {code: 506, message: 'invalid buy', description: '인증 에러'};
export const E_EXPIREDEXCEPTION: IERROR	        = {code: 510, message: 'expired', description: '기간 만료'}
export const E_ACCESS_DENY: IERROR			    = {code: 512, message: 'access deny', description: '접근 거부'}
export const E_NOTPOSSIBLETIME: IERROR          = {code: 516, message: 'time limit', description: '시간 제한'};
export const E_LACK_COST: IERROR            	= {code: 517, message: 'lack cost', description: '비용 부족 에'}
export const E_NOT_JOIN_TIME: IERROR            = {code: 518, message: 'not join time', description: '참여시간 요류'}
...
export const E_GOOGLE_MEMBER_PLATFORM: IERROR   = {code: 590, message: 'google platform', description: '구글 플랫폼계정'}
export const E_APPLE_MEMBER_PLATFORM: IERROR    = {code: 591, message: 'apple platform', description: '애플 플랫폼계정'}
...
export const E_INVALID_BUY: IERROR              = {code: 694, message: 'invalid buy', description: '구매 에러'};
