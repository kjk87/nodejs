...
export class MemberA extends CoreEntity {
    ...
    @Column({type: 'int',  name: 'invite_cash'})
    public inviteCash: number;

    @Column({type: 'int',  name: 'recommend_point'})
    public recommendPoint: number;
    
    @Column({type: 'int',  name: 'reward_point2'})
    public rewardPoint2: number;
    ...
    @Column({type: 'int',  name: 'recommend_cash'})
    public recommendCash: number;

    @Column({type: 'int',  name: 'recommend_wowbox'})
    public recommendWowbox: number;
    ...
    @Column({type: 'int',  name: 'reward_cash'})
